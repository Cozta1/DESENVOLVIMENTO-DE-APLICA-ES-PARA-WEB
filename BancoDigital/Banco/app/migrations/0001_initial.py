    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('saldo', models.DecimalField(decimal_places=2, default=0, editable=False, max_digits=10, verbose_name='Saldo')),
        ...
        migrations.CreateModel(
            name='Notificacao',
            fields=[
                ('idNoti', models.CharField(default=0, editable=False, max_length=10, primary_key=True, serialize=False, unique=True, verbose_name='ID Notificação')),
        ...
        migrations.CreateModel(
            name='Transacao',
            fields=[
                ('numeroTransacao', models.CharField(default=0, editable=False, max_length=10, primary_key=True, serialize=False, unique=True, verbose_name='Número da Transação')),
                ...
                ('status', models.CharField(choices=[('concluida', 'Concluída'), ('cancelada', 'Cancelada')], default='Pendente', editable=False, max_length=10, verbose_name='Status')),
