    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('conta', models.ForeignKey(default=1, on_delete=django.db.models.deletion.CASCADE, to='app.conta')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('contaDestino', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='transacoes_destino', to='app.conta')),
            ],
            options={
