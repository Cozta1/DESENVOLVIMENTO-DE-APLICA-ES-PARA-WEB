...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('tipoNotificacao', models.CharField(max_length=255)),
        ...
        migrations.CreateModel(
            name='Transacao',
            fields=[
                ('numeroTransacao', models.AutoField(editable=False, primary_key=True, serialize=False, unique=True, verbose_name='Número da Transação')),
